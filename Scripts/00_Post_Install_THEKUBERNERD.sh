...
curl https://raw.githubusercontent.com/${GIT_USER}/devops/main/Files/.bashrc.d_common | tee ~/.bashrc.d/common
curl https://raw.githubusercontent.com/${GIT_USER}/devops/main/Files/.bashrc.d_Ubuntu | tee ~/.bashrc.d/Ubuntu
curl https://raw.githubusercontent.com/${GIT_USER}/devops/main/Files/.bashrc.d_K8s | tee ~/.bashrc.d/K8s
. ~/.bashrc
...
git clone https://github.com/${GIT_USER}/eksa.kubernerdes.lab.git
ln -s $HOME/Repositories/Personal/${GIT_USER}/eksa.kubernerdes.lab $HOME
cd $HOME
